...
run_deseq <- function() {
  ...
  plotRLE(eda_set, outline = F, ylim = c(-3, 3), col = colors()[sample_metadata$ip])
...
genes <- c('ENSMUSG00000033208', 'ENSMUSG00000030088', 'ENSMUSG00000020932', 'ENSMUSG00000053279', 'ENSMUSG00000000214')
