...
caption <- 'Cre transcripts are enriched in midbrain and axon samples, however qPCR needs to be done to accurately measure axonal enrichment because of low count number. This highlights the issue of signal to noise: '
caption <- paste0(strwrap(caption, 100), sep="", collapse="\n")
